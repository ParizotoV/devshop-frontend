        ...
        <header className='flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600'>
          ...
          <div className='flex items-center'>
            <div className='relative'>
              <button
                onClick={() => setNotificationOpen(prevState => !prevState)}
              ...
              <div
                className={
                  notificationOpen
                    ? 'block absolute right-0 z-10 mt-2 overflow-hidden bg-white rounded-lg shadow-xl w-80'
                    : 'hidden'
                }
              >
                <a
                ...
                <a className='flex items-center px-4 py-3 -mx-2 text-gray-600 hover:text-white hover:bg-indigo-600'>
                  <img
                    className='object-cover w-8 h-8 mx-1 rounded-full'
            ...
            <div className='relative'>
              ...
              <div
                className={
                  dropdownOpen
                    ? 'block absolute right-0 z-10 w-48 mt-2 overflow-hidden bg-white rounded-md shadow-xl'
                    : 'hidden'
                }
              >
                <a
